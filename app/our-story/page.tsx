...
export const metadata: Metadata = {
  title: "Our Story | Tumor Tactics",
  description:
    "Born from loss. Built with purpose. Discover the story behind Tumor Tactics and meet the student-led team making cancer biology accessible.",
};
...
export default function OurStoryPage() {
  return (
    <>
      <Navbar />
      <main>
        <section className="bg-[#1e1b2e] py-24">
          <div className="mx-auto max-w-4xl px-6">
            <p className="mb-6 text-xs font-bold uppercase tracking-widest text-[#c4b5fd]">Our Story</p>
            <h1
              className="mb-8 text-5xl font-black leading-tight text-white sm:text-6xl"
        ...
        <section className="bg-white py-24">
          <div className="mx-auto max-w-4xl px-6">
            <div className="text-lg leading-relaxed text-[#374151] [&_p]:mb-6 [&_p:last-of-type]:mb-0" style={{ lineHeight: 1.85 }}>
              <div className="float-right mb-6 ml-10 overflow-hidden rounded-2xl border border-[#b4a4f0] shadow-xl max-sm:float-none max-sm:mx-auto max-sm:w-full" style={{ width: 300, maxWidth: "100%" }}>
                <Image
              ...
              <p>Six months after her diagnosis, his grandmother was gone.</p>
              <p>
              ...
              <p>From that moment, Tumor Tactics started to become real.</p>
              <p>
        ...
        <section className="bg-[#1e1b2e] px-8 py-10 sm:px-14">
          <div className="mx-auto flex max-w-5xl flex-col items-stretch gap-10 sm:flex-row sm:gap-14">
            <div className="relative min-h-[420px] shrink-0 overflow-hidden rounded-2xl border-[3px] border-white sm:w-2/5">
              <Image
                src="/assets/team.jpg"
            ...
            <div className="flex items-center py-6 sm:w-3/5">
              <blockquote>
                <p
                  className="mb-8 text-3xl font-black leading-snug text-white sm:text-4xl"
        ...
        <section className="border-t border-[#b4a4f0] bg-white py-16">
          <div className="mx-auto flex max-w-4xl flex-col items-center justify-center gap-6 px-6 sm:flex-row">
            <Link
              href="#our-team"
              className="inline-flex items-center gap-2 rounded-xl bg-[#1e1b2e] px-7 py-3 text-sm font-bold text-white shadow-md transition-[opacity,transform] hover:opacity-90 active:translate-y-px"
            >
              Meet the Team
            </Link>
            <Link
              href="/how-to-play"
              className="inline-flex items-center gap-2 rounded-xl border border-[#c4b5fd] bg-white px-7 py-3 text-sm font-bold text-[#7c3aed] transition-[background-color,transform] hover:bg-[#ede9fe] active:translate-y-px"
            >
              See the Game
            </Link>
          </div>
          <p className="mt-8 px-6 text-center text-xs italic text-[#9ca3af]">
